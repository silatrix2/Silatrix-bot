...
async function warnCommand(sock, chatId, senderId, mentionedJids, message) {
    try {
        ...
        try {
            ...
            if (!isBotAdmin) {
                await sock.sendMessage(chatId, { 
                    text: '❌ Error:  make the bot an admin first to use this command.'
                });
                return;
            }
            ...
            await sock.sendMessage(chatId, { 
                text: '❌ Error:  make sure the bot is an admin of this group.'
            });
            return;
        }
        ...
        if (!userToWarn) {
            await sock.sendMessage(chatId, { 
                text: '❌ Error:  mention the user or reply to their message to warn!'
            });
            return;
        }
