...
async function muteCommand(sock, chatId, senderId, durationInMinutes) {
    ...
    if (!isBotAdmin) {
        await sock.sendMessage(chatId, { text: ' make SILATRIX an admin first.' });
        return;
    }
    ...
    try {
        ...
        setTimeout(async () => {
            ...
            await sock.sendMessage(chatId, { text: 'The group has been unmuted peasants. * SILATRIX MD is awsome* ' });
